...
case class MPrimitive(_idlName: String, jName: String, kName: String, jniName: String, cName: String, jBoxed: String, jSig: String, objcName: String, objcBoxed: String) extends MOpaque { val numParams = 0; val idlName = _idlName }
...
val defaults: Map[String,MOpaque] = immutable.HashMap(
  ...
  ("i16",  MPrimitive("i16",  "short",   "Short",   "jshort",   "int16_t", "Short",   "S", "int16_t", "NSNumber")),
  ("i32",  MPrimitive("i32",  "int",     "Int",     "jint",     "int32_t", "Integer", "I", "int32_t", "NSNumber")),
  ("i64",  MPrimitive("i64",  "long",    "Long",    "jlong",    "int64_t", "Long",    "J", "int64_t", "NSNumber")),
  ("f32",  MPrimitive("f32",  "float",   "Float",   "jfloat",   "float",   "Float",   "F", "float",   "NSNumber")),
  ("f64",  MPrimitive("f64",  "double",  "Double",  "jdouble",  "double",  "Double",  "D", "double",  "NSNumber")),
  ("bool", MPrimitive("bool", "boolean", "Boolean", "jboolean", "bool",    "Boolean", "Z", "BOOL",    "NSNumber")),
  ("string", MString),
  ("binary", MBinary),
  ("optional", MOptional),
  ("date", MDate),
